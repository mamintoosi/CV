...
\hypersetup{pdfauthor=Mahmood Amintoosi, pdfcreator=Ferdowsi University of Mashhad}
...
\extrainfo{\httplink[http://mamintoosi.github.io]{mamintoosi.github.io}} 
...
\fill[blue!5]
  (current page.north west) rectangle ([yshift=-5cm]current page.east|-{pic cs:end});
\end{tikzpicture}
...
{دانشکده علوم ریاضی}
{ دانشگاه فردوسی  مشهد}{}{}
\cventry{1380 - 1402}{عضو هیأت علمی}{دانشکده ریاضی و علوم کامپیوتر}{دانشگاه حکیم سبزواری}{}{}
...
\cvlistdoubleitem[\Neutral]{نظریه یادگیری}{مبانی ریاضی علوم داده }
...
\cvline{۱۴۰۴}{ کارگاه آشنایی با ژوپیتربوک، {\small دانشگاه فردوسی مشهد}، \httplink[لینک وب سایت]{https://fum-cs.github.io/jupyter-book-tutorial/}}
\cvline{۱۴۰۳}{ کارگاه شبکه‌های عصبی پیچشی گراف، {\small دانشگاه فردوسی مشهد}، \httplink[لینک وب سایت]{https://gta-lab.github.io/GNN-workshop/}} %\newline\footnotesize
%\url{{https://github.com/GTA-Lab/GNN-workshop}}}
...
\lr{TensorFlow}، {\small دانشگاه حکیم سبزواری}، \httplink[اسلایدها در گیت‌هاب]{https://mamintoosi.github.io/slides/topics/DL-TF/index.html}
%\newline\footnotesize
...
\cvline{۱۴۰۴-۱۳۹۵}{داوری مقالات در چند کنفرانس و سمینار  در دانشگاه ‌های فردوسی مشهد و حکیم سبزواری}
...
\cvline{۱۳۹۲}{داوری مقالات در \lr{Symposium on Artificial Intelligence and Signal Processing 2013}}
...
\cvline{داوری در}{\lr{ IEEE Trans. Pattern Anal. Mach. Intell, IET Image Processing Journal, IEEE Trans. on Sys., Man, and Cybernetics}}
...
\cvline{1402}{	عضو هیات علمی برگزیده پژوهشی دانشکده ریاضی و علوم کامپیوتر دانشگاه حکیم سبزواری 
}
\cvline{1401}{	عضو هیات علمی برگزیده آموزشی دانشکده ریاضی و علوم کامپیوتر دانشگاه حکیم سبزواری 
}
...
\cvline{}{	پیگیری راه‌اندازی رشته کارشناسی ارشد علوم کامپیوتر در دانشگاه فردوسی مشهد
}
\cvline{}{	مجری بازنگری برنامه درسی دوره کارشناسی علوم کامپیوتر در دانشگاه فردوسی مشهد
}
...
}\cvline{}{	راه‌اندازی کارگاه کامپیوتر دانشکده ریاضی و علوم کامپیوتر}\cvline{}{	عضویت در  کارگروه بررسی صلاحیت عمومی دانشگاه 
...
}\cvline{}{	عضویت در  شورای فناوری اطلاعات 
}\cvline{}{	عضویت در  شورای پژوهشی دانشگاه 
}\cvline{}{	عضویت در  شورای نظارت دانشگاه
}\cvline{}{	راه‌اندازی سیستم اتوماسیون ترفیع
}
%\cvline{}{	دیریت وب سایت گروه علوم کامپیوتر
%}
